...
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/recipes-bsp/imx-mkimage/imx-boot_0.2.bb < sources/meta-seco-bsp-release-imx8-ga/patches/dtb-not-fetching.patch
# Patch meta-fsl layer adding dtbo support
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/classes/image_types_fsl.bbclass < sources/meta-seco-bsp-release-imx8-ga/patches/0001-Yocto-i.MX8-DTBo-added-dtbo-support.patch
...
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-seco-bsp-release-imx8-ga \"" >> $BUILD_DIR/conf/bblayers.conf
